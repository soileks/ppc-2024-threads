...
bool SparseMatrixComplexMultiSequential::validation() {
  internal_order_test();
...
bool SparseMatrixComplexMultiSequential::pre_processing() {
  internal_order_test();
...
bool SparseMatrixComplexMultiSequential::run() {
  internal_order_test();
...
bool SparseMatrixComplexMultiSequential::post_processing() {
  internal_order_test();
