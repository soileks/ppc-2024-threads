...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Simple_128) {
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Random_128) {
  constexpr size_t matrix_size = 128;
  std::mt19937 gen(1);
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Simple_32) {
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Random_32) {
  constexpr size_t matrix_size = 32;
  const double tolerance = 1e-5;
  std::mt19937 gen(1);
  std::uniform_real_distribution<> dis(1.0, 6.0);
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Simple_64) {
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Random_64) {
  constexpr size_t matrix_size = 64;
  const double tolerance = 1e-5;
  std::mt19937 gen(1);
  std::uniform_real_distribution<> dis(1.0, 6.0);
