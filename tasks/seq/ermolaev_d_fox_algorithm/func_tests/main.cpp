...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Simple_50) {
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Random_50) {
  constexpr size_t matrix_size = 50;
  std::mt19937 gen(1);  // Инициализация генератора случайных чисел с начальным значением 1
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Simple_75) {
  constexpr size_t matrix_size = 75;
  std::vector<double> A(matrix_size * matrix_size, 1.0);
  std::vector<double> B(matrix_size * matrix_size, 2.0);
  std::vector<double> C(matrix_size * matrix_size, 0.0);
  std::vector<double> expected(matrix_size * matrix_size, matrix_size * 2.0);
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Random_75) {
  constexpr size_t matrix_size = 75;
  const double tolerance = 1e-5;
  std::mt19937 gen(1);  // Инициализация генератора случайных чисел с начальным значением 1
  std::uniform_real_distribution<> dis(5.0, 1e-5);
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Simple_80) {
  constexpr size_t matrix_size = 80;
  std::vector<double> A(matrix_size * matrix_size, 1.0);
  std::vector<double> B(matrix_size * matrix_size, 2.0);
  std::vector<double> C(matrix_size * matrix_size, 0.0);
  std::vector<double> expected(matrix_size * matrix_size, matrix_size * 2.0);
...
TEST(ermolaev_d_fox_algorithm_seq, Test_Matrix_Multiplication_Random_80) {
  constexpr size_t matrix_size = 80;
  const double tolerance = 1e-5;
  std::mt19937 gen(1);  // Инициализация генератора случайных чисел с начальным значением 1
  std::uniform_real_distribution<> dis(5.0, 1e-5);
