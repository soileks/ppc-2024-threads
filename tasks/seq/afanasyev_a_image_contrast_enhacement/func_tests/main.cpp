...
TEST(afanasyev_a_image_contrast_enhacement_seq, validation_error_input_pixels_empty) {
...
TEST(afanasyev_a_image_contrast_enhacement_seq, validation_error_input_output_pixels_size_different) {
...
TEST(afanasyev_a_image_contrast_enhacement_seq, test_small_pixels) {
...
TEST(afanasyev_a_image_contrast_enhacement_seq, test_large_random_pixels) {
