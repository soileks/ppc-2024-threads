...
TEST(Dijkstra_Shipilov_seq_test, Test_Correct_Work_One) {
  // Create data
...
TEST(Dijkstra_Shipilov_seq_test, Test_Correct_Work_Two) {
  // Create data
...
TEST(Dijkstra_Shipilov_seq_test, Test_Correct_Work_Three) {
  // Create data
  std::vector<std::tuple<int, int, int> > in{{0, 1, 4}, {0, 3, 1}, {0, 2, 3}, {3, 2, 1}, {3, 4, 4}, {2, 4, 2}};
  std::vector<Dijkstra::path_data_t> out{{0, 0}, {0, 4}, {3, 2}, {0, 1}, {2, 4}};
...
TEST(Dijkstra_Shipilov_seq_test, Test_Correct_Work_Four) {
  // Create data
...
TEST(Dijkstra_Shipilov_seq_test, Test_Correct_Work_Five) {
  // Create data
