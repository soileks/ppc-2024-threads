...
bool checkSolution(const std::vector<double>& A, const std::vector<double>& b, const std::vector<double>& x, double tol) {
    int n = b.size();
...
std::vector<double> SystemsGradMethodSeq::matrixVectorProduct(const std::vector<double>& A, const std::vector<double>& x, int n) {
...
std::vector<double> SystemsGradMethodSeq::SLEgradSolver(const std::vector<double>& A, const std::vector<double>& b, int n, double tol) {
