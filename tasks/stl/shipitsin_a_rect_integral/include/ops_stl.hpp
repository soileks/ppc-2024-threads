...
class ShipitsinTaskSTL : public ppc::core::Task {
 public:
  explicit ShipitsinTaskSTL(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
