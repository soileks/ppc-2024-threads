...
TEST(kochetov_n_gauss_filter_stl, Test_GaussFilter_SmallImage) {
...
TEST(kochetov_n_gauss_filter_stl, Test_GaussFilter_SmallImage2) {
...
TEST(kochetov_n_gauss_filter_stl, Test_GaussFilter_EmptyImage) {
  int* image = nullptr;
  int* output = nullptr;
...
TEST(kochetov_n_gauss_filter_stl, Test_GaussFilter_SinglePixel) {
  int image[1] = {128};
  int output[1] = {128};
...
TEST(kochetov_n_gauss_filter_stl, Test_GaussFilter_LargeImage) {
...
TEST(kochetov_n_gauss_filter_stl, Test_GaussFilter_BorderEffect) {
