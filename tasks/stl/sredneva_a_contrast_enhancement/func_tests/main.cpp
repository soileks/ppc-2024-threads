...
TEST(sredneva_a_contrast_enhancement_stl, test_1) {
  int n = 3;
  int m = 3;
  ...
  // Create Task
  ContrastEnhancement_STL_Sequential testStlTaskSequential(taskDataSeq);
  ...
  // Create Task
  ContrastEnhancement_STL_Parallel testStlTaskParallel(taskDataPar);
  ASSERT_EQ(testStlTaskParallel.validation(), true);
  testStlTaskParallel.pre_processing();
  ASSERT_EQ(testStlTaskParallel.run(), true);
...
TEST(sredneva_a_contrast_enhancement_stl, test_2) {
  int n = 4;
  int m = 3;
...
TEST(sredneva_a_contrast_enhancement_stl, test_3_rand) {
  int n = 5;
  int m = 4;
  uint8_t min = 75;
  uint8_t max = 200;
...
TEST(sredneva_a_contrast_enhancement_stl, test_4_all_5) {
  int n = 3;
  int m = 2;
  ...
  ASSERT_EQ(testStlTaskParallel.validation(), true);
  testStlTaskParallel.pre_processing();
  ASSERT_EQ(testStlTaskParallel.run(), false);
  testStlTaskParallel.post_processing();
}

TEST(sredneva_a_contrast_enhancement_stl, test_5) {
  int n = 2;
  int m = 4;
