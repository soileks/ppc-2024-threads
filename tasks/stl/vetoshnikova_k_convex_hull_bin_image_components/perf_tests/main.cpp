...
TEST(vetoshnikova_k_hull_bin_image_stl, test_pipeline_run) {
  int h = 200;
  int w = 200;
  // Create data
  ...
  // Create Task
  auto testTask = std::make_shared<vetoshnikova_stl::ConstructingConvexHullSTL>(taskData);
...
TEST(vetoshnikova_k_hull_bin_image_stl, test_task_run) {
  int h = 200;
  int w = 200;
  // Create data
  std::vector<int> out(10 * w * h);
