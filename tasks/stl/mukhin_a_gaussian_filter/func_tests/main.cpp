...
TEST(mukhin_i_a_gaussian_filter_block_stl, can_work_with_black_pixel_map) {
  // Create data
  uint32_t width = 32;
  uint32_t height = 32;
  ...
  // Create Task
  mukhin_i_stl::GaussianFilterSTL testTaskSequential(taskDataSeq);
...
TEST(mukhin_i_a_gaussian_filter_block_stl, can_work_with_white_pixel_map) {
  // Create data
  uint32_t width = 32;
  uint32_t height = 32;
...
TEST(mukhin_i_a_gaussian_filter_block_stl, can_work_with_middle_pixel_map) {
  // Create data
  uint32_t width = 32;
  uint32_t height = 32;
...
TEST(mukhin_i_a_gaussian_filter_block_stl, can_work_with_small_pixel_map) {
  // Create data
  uint32_t width = 6;
  uint32_t height = 6;
  PixelMap in(width, height);
...
TEST(mukhin_i_a_gaussian_filter_block_stl, can_work_with_big_pixel_map) {
  // Create data
  uint32_t width = 300;
  uint32_t height = 300;
  PixelMap in(width, height);
