...
TEST(bonyuk_p_gauss_gorizont, stl_one_test) {
  int n = 3;
  int m = 3;
...
TEST(bonyuk_p_gauss_gorizont, stl_two_test) {
  int n = 3;
  int m = 3;
...
TEST(bonyuk_p_gauss_gorizont, stl_three_test) {
  int n = 3;
  int m = 3;
...
TEST(bonyuk_p_gauss_gorizont, stl_four_test) {
  int n = 5;
  int m = 5;
...
TEST(bonyuk_p_gauss_gorizont, stl_five_test) {
  int n = 5;
  int m = 5;
