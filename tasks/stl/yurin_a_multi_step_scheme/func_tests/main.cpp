...
TEST(Yurin_A_Multi_Step_Scheme_STL, incorrect_data) {
  // Create data
  ...
  // Create Task
  MultiStepSchemeSTL multiStepSchemeSTL(taskDataSeq);

  ASSERT_FALSE(multiStepSchemeSTL.validation());
}

TEST(Yurin_A_Multi_Step_Scheme_STL, simple_test) {
  // Create data
  ...
  ASSERT_TRUE(multiStepSchemeSTL.validation());
  ASSERT_TRUE(multiStepSchemeSTL.pre_processing());
  ASSERT_TRUE(multiStepSchemeSTL.run());
  ASSERT_TRUE(multiStepSchemeSTL.post_processing());
...
TEST(Yurin_A_Multi_Step_Scheme_STL, first_test) {
  // Create data
  std::vector<double> equation{-2, -3, 1, -2, 0, 0};
...
TEST(Yurin_A_Multi_Step_Scheme_STL, second_test) {
  // Create data
...
TEST(Yurin_A_Multi_Step_Scheme_STL, fird_test) {
  // Create data
