...
TEST(tushentsova_k_marking_bin_image_stl_func, test_ones) {
  uint32_t height = 5;
  uint32_t width = 5;
  ...
  markingImageStl testTaskParallel(taskDataPar);
...
TEST(tushentsova_k_marking_bin_image_stl_func, test_zeros) {
  uint32_t height = 5;
  uint32_t width = 5;
  std::vector<uint32_t> size = {height, width};
  std::vector<uint8_t> in(height * width, 1);
...
TEST(tushentsova_k_marking_bin_image_stl_func, test_all_alternation) {
  uint32_t height = 6;
  uint32_t width = 6;
  std::vector<uint32_t> size = {height, width};
...
TEST(tushentsova_k_marking_bin_image_stl_func, test_func1) {
  uint32_t height = 5;
  uint32_t width = 5;
  std::vector<uint32_t> size = {height, width};
...
TEST(tushentsova_k_marking_bin_image_stl_func, test_func2) {
  uint32_t height = 3;
  uint32_t width = 6;
  std::vector<uint32_t> size = {height, width};
