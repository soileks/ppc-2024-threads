...
TEST(sobol_l_sobel_stl, test_handle_empty_image) {
  int width = 0;
  int height = 0;
  ...
  sobol::Sobel_stl sobel(taskData, width, height);
...
TEST(sobol_l_sobel_stl, test_handle_one_by_one_image) {
  int width = 1;
  int height = 1;
...
TEST(sobol_l_sobel_stl, test_handle_three_by_three_image) {
  int width = 3;
  int height = 3;
...
TEST(sobol_l_sobel_stl, test_handle_standard_image) {
  int width = 100;
  int height = 100;
...
TEST(sobol_l_sobel_stl, test_handle_wide_image) {
  int width = 100;
  int height = 10;
...
TEST(sobol_l_sobel_stl, test_handle_gradient_image) {
  int width = 10;
  int height = 10;
