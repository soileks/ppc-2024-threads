...
TEST(pozdnyakov_v_rect_integral_stl, test_pipeline_run) {
  double res = 217.0907;
  ...
  auto testTaskSTL = std::make_shared<PozdnyakovTaskSTL>(taskDataSeq);
...
TEST(pozdnyakov_v_rect_integral_stl, test_task_run) {
  double res = 217.0907;
  Func f = pozdnyakov_fxexpy;
  int n = 5000;
