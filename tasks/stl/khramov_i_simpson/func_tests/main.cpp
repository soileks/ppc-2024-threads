...
using namespace khramov_stl;

TEST(khramov_i_simpson_stl, Test_Linear_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 4;
  int b2 = 4;
  ...
  // Create Task
  TestSimpsonStlsequential testTaskSequential(taskDataSeq, func);
  ...
  // Create Task
  TestSimpsonStlParallel testTaskParallel(taskDataPar, func);
...
TEST(khramov_i_simpson_stl, Test_Square_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
...
TEST(khramov_i_simpson_stl, Test_Sin_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
...
TEST(khramov_i_simpson_stl, Test_Mult_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
...
TEST(khramov_i_simpson_stl, Test_Exp_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
