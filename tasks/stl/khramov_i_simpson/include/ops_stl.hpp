...
namespace khramov_stl {

using function = double (*)(double, double);

class TestSimpsonStlsequential : public ppc::core::Task {
 public:
  explicit TestSimpsonStlsequential(std::shared_ptr<ppc::core::TaskData> taskData_, function func_)
...
class TestSimpsonStlParallel : public ppc::core::Task {
 public:
  explicit TestSimpsonStlParallel(std::shared_ptr<ppc::core::TaskData> taskData_, function func_)
      : Task(std::move(taskData_)), func(std::move(func_)) {}
  bool pre_processing() override;
  bool validation() override;
  bool run() override;
