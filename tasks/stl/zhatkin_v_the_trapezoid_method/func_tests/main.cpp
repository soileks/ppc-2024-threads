...
#include "stl/zhatkin_v_the_trapezoid_method/include/trapezoid_method_stl.hpp"

TEST(zhatkin_v_trapezoid_stl, Test1) {
  double lowerx = 0.0;
  double upperx = 0.0;
  double lowery = 0.0;
  double uppery = 0.0;
  ...
  // Create Task
  ZhatkinTaskSTL testTaskSequential(taskDataSeq, sqr_x_y);
  ...
  // Create Task
  ZhatkinTaskSTL testOmpTaskParallel(taskDataPar, sqr_x_y);
...
TEST(zhatkin_v_trapezoid_stl, Test2) {
  double lowerx = 0.0;
  double upperx = 1.0;
  double lowery = 0.0;
  double uppery = 1.0;
  ...
  // Create Task
  ZhatkinTaskSTL testTaskSequential(taskDataSeq, productXY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  ZhatkinTaskSTL testOmpTaskParallel(taskDataPar, productXY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(zhatkin_v_trapezoid_stl, Test3) {
  double lowerx = 0.0;
  ...
  // Create Task
  ZhatkinTaskSTL testTaskSequential(taskDataSeq, sumCosSin);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  ZhatkinTaskSTL testOmpTaskParallel(taskDataPar, sumCosSin);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(zhatkin_v_trapezoid_stl, Test4) {
  ...
  // Create Task
  ZhatkinTaskSTL testTaskSequential(taskDataSeq, productXsinY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  ZhatkinTaskSTL testOmpTaskParallel(taskDataPar, productXsinY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(zhatkin_v_trapezoid_stl, Test5) {
  double lowerx = 1.0;
  double upperx = 2.0;
  double lowery = 1.0;
  double uppery = 2.0;
  ...
  // Create Task
  ZhatkinTaskSTL testTaskSequential(taskDataSeq, quotientXY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  ZhatkinTaskSTL testOmpTaskParallel(taskDataPar, quotientXY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
