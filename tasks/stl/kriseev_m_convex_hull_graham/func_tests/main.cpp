...
TEST(kriseev_m_convex_hull_graham_seq, ThreePoints) {
  ...
  KriseevMTaskStl::ConvexHullTask task(data);
...
TEST(kriseev_m_convex_hull_graham_seq, Square) {
  std::vector<double> pX;
  pX.emplace_back(2.0);
  pX.emplace_back(5.0);
  pX.emplace_back(5.0);
  ...
  std::vector<KriseevMTaskStl::Point> expectedPoints = {
      {pX[1], pY[1]},
      {pX[2], pY[2]},
      {pX[0], pY[0]},
      {pX[3], pY[3]},
...
TEST(kriseev_m_convex_hull_graham_seq, SquareWithPointInTheMiddle) {
  std::vector<double> pX;
  pX.emplace_back(2.0);
  pX.emplace_back(5.0);
  pX.emplace_back(5.0);
...
TEST(kriseev_m_convex_hull_graham_seq, SquareWithPointOnEdge) {
  std::vector<double> pX;
  pX.emplace_back(2.0);
  pX.emplace_back(5.0);
  pX.emplace_back(5.0);
...
TEST(kriseev_m_convex_hull_graham_seq, PentagonWithPointsInside) {
  std::vector<double> pX;
  pX.emplace_back(1.5);
