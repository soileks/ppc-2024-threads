...
class ConjugateGradientMethodSTL : public ppc::core::Task {
 public:
  explicit ConjugateGradientMethodSTL(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
