...
TEST(volodin_e_sobel_stl, Test_Sobel_Simple_Image_5x5) {
  const int height = 5;
  const int width = 5;
  ...
  SobelTaskStlVolodin sobelTaskStl(taskDataStl);
  ASSERT_EQ(sobelTaskStl.validation(), true);
  sobelTaskStl.pre_processing();
  sobelTaskStl.run();
  sobelTaskStl.post_processing();
...
TEST(volodin_e_sobel_stl, Test_Sobel_Simple_Image_5x7) {
  const int width = 5;
  const int height = 7;
...
TEST(volodin_e_sobel_stl, Test_Sobel_Simple_Image_11x11) {
  const int height = 11;
  const int width = 11;
...
TEST(volodin_e_sobel_stl, Test_Sobel_White_Image) {
  const int height = 5;
  const int width = 5;
...
TEST(volodin_e_sobel_stl, Test_Sobel_Black_Image) {
  const int width = 5;
  const int height = 5;
...
TEST(volodin_e_sobel_stl, Test_Sobel_Random_Image) {
  const int width = 256;
...
TEST(volodin_e_sobel_stl, Test_Sobel_Random_Image_2) {
  const int width = 300;
