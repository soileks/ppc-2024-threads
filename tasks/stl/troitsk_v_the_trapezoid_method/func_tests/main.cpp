...
TEST(troitsk_v_trapezoid_stl, Test1) {
  double lowerx = 0.0;
  double upperx = 0.0;
  double lowery = 0.0;
  double uppery = 0.0;
  ...
  // Create Task
  troitskTaskSTL testTaskSequential(taskDataSeq, sqr_x_y);
  ...
  // Create Task
  troitskTaskSTL testOmpTaskParallel(taskDataPar, sqr_x_y);
...
TEST(troitsk_v_trapezoid_stl, Test2) {
  double lowerx = 0.0;
  double upperx = 1.0;
  double lowery = 0.0;
  double uppery = 1.0;
  ...
  // Create Task
  troitskTaskSTL testTaskSequential(taskDataSeq, productXY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  troitskTaskSTL testOmpTaskParallel(taskDataPar, productXY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(troitsk_v_trapezoid_stl, Test3) {
  double lowerx = 0.0;
  ...
  // Create Task
  troitskTaskSTL testTaskSequential(taskDataSeq, sumCosSin);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  troitskTaskSTL testOmpTaskParallel(taskDataPar, sumCosSin);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(troitsk_v_trapezoid_stl, Test4) {
  ...
  // Create Task
  troitskTaskSTL testTaskSequential(taskDataSeq, productXsinY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  troitskTaskSTL testOmpTaskParallel(taskDataPar, productXsinY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(troitsk_v_trapezoid_stl, Test5) {
  double lowerx = 1.0;
  double upperx = 2.0;
  double lowery = 1.0;
  double uppery = 2.0;
  ...
  // Create Task
  troitskTaskSTL testTaskSequential(taskDataSeq, quotientXY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  troitskTaskSTL testOmpTaskParallel(taskDataPar, quotientXY);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
