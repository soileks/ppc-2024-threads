...
using namespace smirnova_stl;

TEST(smirnova_d_complex_matrix_crs_stl, test_square_matrix_by_itself) {
  crs_matrix A;
  A.n_rows = 5;
  A.n_cols = 5;
  ...
  // Create Task
  StlTestComplexMatrixCrsSeq taskSequential(taskDataSeq);
  ...
  // Create Task
  StlTestComplexMatrixCrsPar taskParallel(taskDataPar);
...
TEST(smirnova_d_complex_matrix_crs_stl, test_square_matrix) {
  crs_matrix A;
  A.n_rows = 4;
  A.n_cols = 4;
  A.pointer = {0, 2, 4, 6, 7};
...
TEST(smirnova_d_complex_matrix_crs_stl, test_non_square_matrix) {
  crs_matrix A;
  A.n_rows = 2;
  A.n_cols = 3;
  A.pointer = {0, 2, 3};
...
TEST(smirnova_d_complex_matrix_crs_stl, test_inverse_matrix) {
  crs_matrix A;
  A.n_rows = 4;
  A.n_cols = 4;
  A.pointer = {0, 1, 3, 5, 8};
...
TEST(smirnova_d_complex_matrix_crs_stl, test_complex_matrix) {
  crs_matrix A;
  A.n_rows = 5;
  A.n_cols = 4;
...
TEST(smirnova_d_complex_matrix_crs_stl, test_complex_matrix_diagonal) {
  crs_matrix A;
  A.n_rows = 3;
  A.n_cols = 3;
  A.pointer = {0, 1, 2, 3};
