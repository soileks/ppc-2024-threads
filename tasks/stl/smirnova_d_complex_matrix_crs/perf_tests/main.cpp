...
TEST(smirnova_d_complex_matrix_crs_stl, test_pipeline_run) {
  ...
  // Create Task
  auto testTaskSTL = std::make_shared<StlTestComplexMatrixCrsPar>(taskDataSeq);
...
TEST(smirnova_d_complex_matrix_crs_stl, test_task_run) {
  crs_matrix A = generate_random_matrix(100, 100, 0.6, 1993);
  crs_matrix B = generate_random_matrix(100, 100, 0.6, 4325);
  crs_matrix Result;
