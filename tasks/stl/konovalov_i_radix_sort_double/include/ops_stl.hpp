...
class RadixSortSTLTaskParallel : public ppc::core::Task {
 public:
  explicit RadixSortSTLTaskParallel(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
