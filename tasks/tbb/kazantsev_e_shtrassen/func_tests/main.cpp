...
TEST(kazantsev_e_matmul_strassen_seq, multSecShtrassen_4x4) {
  ...
  // Create Task
  MatMulStrassenTbb MatMulStrassenTbb(taskDataSeq);
  ASSERT_EQ(MatMulStrassenTbb.validation(), true);
  MatMulStrassenTbb.pre_processing();
  MatMulStrassenTbb.run();
  MatMulStrassenTbb.post_processing();
