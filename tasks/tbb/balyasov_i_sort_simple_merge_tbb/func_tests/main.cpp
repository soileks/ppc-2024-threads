...
TEST(balyasov_i_sort_simple_merge_tbb, test_three_values) {
  // Create data
  ...
  // Create Task
  RadixSortClassTaskTbb Task(taskDataSeq);
...
TEST(balyasov_i_sort_simple_merge_tbb, test_eleven_values) {
  // Create data
...
TEST(balyasov_i_sort_simple_merge_tbb, test_with_duplicate) {
  // Create data
...
TEST(balyasov_i_sort_simple_merge_tbb, sort_random_vector) {
  // Create data
...
TEST(balyasov_i_sort_simple_merge_tbb, validation_test) {
  // Create data
