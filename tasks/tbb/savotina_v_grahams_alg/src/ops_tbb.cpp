...
bool SavotinaGrahamsAlgorithmTbbParallel::validation() {
  internal_order_test();
...
bool SavotinaGrahamsAlgorithmTbbParallel::run() {
  internal_order_test();
...
bool SavotinaGrahamsAlgorithmTbbParallel::post_processing() {
  internal_order_test();
