...
TEST(shubin_m_double_crs_mult_tbb, incorr_in_mats) {
  ...
  SparseMat_CRS_Mult_TBB crs_mat_mult_tbb(taskDataTBB);
  ASSERT_FALSE(crs_mat_mult_tbb.validation());
}

TEST(shubin_m_double_crs_mult_tbb, mat_in_1_zero) {
  ...
  SparseMat_CRS_Mult_TBB crs_mat_mult_tbb(taskDataTBB);
  ASSERT_TRUE(crs_mat_mult_tbb.validation());
  ASSERT_TRUE(crs_mat_mult_tbb.pre_processing());
  ASSERT_TRUE(crs_mat_mult_tbb.run());
  ASSERT_TRUE(crs_mat_mult_tbb.post_processing());
...
TEST(shubin_m_double_crs_mult_tbb, mat_in_2_zero) {
  size_t mat_in_1_row = 3;
  size_t mat_in_1_col = 3;
  size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
...
TEST(shubin_m_double_crs_mult_tbb, mat_in_1_ident) {
  size_t mat_in_1_row = 3;
  // size_t mat_in_1_col = 3;
  size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
...
TEST(shubin_m_double_crs_mult_tbb, mat_in_2_ident) {
  size_t mat_in_1_row = 3;
  size_t mat_in_1_col = 3;
  // size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
...
TEST(shubin_m_double_crs_mult_tbb, random_small_dim_mat_mult) {
  size_t mat_in_1_row = 3;
  size_t mat_in_1_col = 3;
  size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
