...
TEST(Yurin_A_Multi_Step_Scheme_TBB, incorrect_data) {
  // Create data
  ...
  // Create Task
  MultiStepSchemeTBB multiStepSchemeOMP(taskDataSeq);

  ASSERT_FALSE(multiStepSchemeOMP.validation());
}

TEST(Yurin_A_Multi_Step_Scheme_TBB, simple_test) {
  // Create data
  ...
  ASSERT_TRUE(multiStepSchemeOMP.validation());
  ASSERT_TRUE(multiStepSchemeOMP.pre_processing());
  ASSERT_TRUE(multiStepSchemeOMP.run());
  ASSERT_TRUE(multiStepSchemeOMP.post_processing());
...
TEST(Yurin_A_Multi_Step_Scheme_TBB, first_test) {
  // Create data
  std::vector<double> equation{-2, -3, 1, -2, 0, 0};
...
TEST(Yurin_A_Multi_Step_Scheme_TBB, second_test) {
  // Create data
...
TEST(Yurin_A_Multi_Step_Scheme_TBB, fird_test) {
  // Create data
