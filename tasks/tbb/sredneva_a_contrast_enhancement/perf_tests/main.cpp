...
TEST(sredneva_a_contrast_enhancement_tbb, test_pipeline_run) {
  int n = 2000;
  int m = 1500;
  uint8_t min = 75;
  uint8_t max = 150;
  ...
  // Create Task
  auto testTaskTBB = std::make_shared<ContrastEnhancement_TBB_Parallel>(taskDataSeq);
...
TEST(sredneva_a_contrast_enhancement_tbb, test_task_run) {
  int n = 2000;
  int m = 1500;
  uint8_t min = 75;
  uint8_t max = 150;
