...
TEST(kruglov_a_components_marking_tbb_perf_test, test_pipeline_run) {
  // Create data
  ...
  // Create Task
  auto testTaskParallel = std::make_shared<imgMarkingTbb>(taskDataTbb);
...
TEST(kruglov_a_components_marking_tbb_perf_test, test_task_run) {
  // Create data
