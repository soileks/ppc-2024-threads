...
TEST(borisov_s_convex_hull_tbb, test_pipeline_run) {
  size_t width = 2000;
  size_t height = 3;
  ...
  // Create Task
  auto convexHull = std::make_shared<BorisovSaveliyTBB::ConvexHull>(taskDataSeq);
...
TEST(borisov_s_convex_hull_tbb, test_task_run) {
  size_t width = 2000;
  size_t height = 3;
