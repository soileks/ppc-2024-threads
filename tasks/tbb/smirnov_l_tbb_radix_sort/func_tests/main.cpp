...
TEST(Smirnov_L_Radix_Sort_Test_TBB, Test_Cor_Work_Real_One_TBB_Sm) {
  ...
  // Create Task
  RadixSortTBBMethod radixSortTBBTask(taskDataPar);
  ASSERT_EQ(radixSortTBBTask.validation(), true);
  ASSERT_TRUE(radixSortTBBTask.pre_processing());
  ASSERT_TRUE(radixSortTBBTask.run());
  ASSERT_TRUE(radixSortTBBTask.post_processing());
...
TEST(Smirnov_L_Radix_Sort_Test_TBB, Test_Cor_Work_Real_Two_TBB_Sm) {
...
TEST(Smirnov_L_Radix_Sort_Test_TBB, Test_Cor_Work_Real_Three_TBB_Sm) {
...
TEST(Smirnov_L_Radix_Sort_Test_TBB, Test_Cor_Work_Real_Four_TBB_Sm) {
...
TEST(Smirnov_L_Radix_Sort_Test_TBB, Test_Cor_Work_Real_Five_TBB_Sm) {
