...
TEST(Petrov_M_Radix_Sort_TBB, Test_With_Positive_Numbers) {
  // Create data
...
TEST(Petrov_M_Radix_Sort_TBB, Test_With_Negative_Numbers) {
  // Create data
  std::vector<double> in{-2.5, -3.22, -5.32, -1.11};
...
TEST(Petrov_M_Radix_Sort_TBB, Test_With_Positive_and_Negative_Numbers) {
  // Create data
  std::vector<double> in{2.5, -3.22, 5.32, -1.11};
...
TEST(Petrov_M_Radix_Sort_TBB, Test_With_Positive_Numbers2) {
  // Create data
...
TEST(Petrov_M_Radix_Sort_TBB, Test_With_Negative_Numbers2) {
  // Create data
...
TEST(Petrov_M_Radix_Sort_TBB, Test_With_Positive_and_Negative_Numbers3) {
