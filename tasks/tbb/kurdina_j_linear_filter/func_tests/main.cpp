...
TEST(kurdina_j_linear_filter_tbb, Image_1) {
  int n = 3;
  int m = 3;
  ...
  // Create Task
  HorizontalSplitTBB_seq horizontalsplit_seq(taskDataSeq);
  ...
  // Create Task
  HorizontalSplitTBB_parallel horizontalsplit_parallel(taskDataPar);
...
TEST(kurdina_j_linear_filter_tbb, Image_2) {
  int n = 3;
  int m = 3;
...
TEST(kurdina_j_linear_filter_tbb, Image_3) {
  int n = 3;
  int m = 3;
  std::vector<uint8_t> gauss_kernel = {1, 1, 1, 1, 1, 1, 1, 1, 1};
...
TEST(kurdina_j_linear_filter_tbb, Check_validation_1) {
  int n = 3;
  int m = 3;
...
TEST(kurdina_j_linear_filter_tbb, Check_validation_2) {
  int n = 3;
  int m = 3;
  std::vector<uint8_t> gauss_kernel = {1, 1, 1, 1, 1, 1, 1, 1, 1};
