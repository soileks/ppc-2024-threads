...
bool vinichuk_t_tbb::MultMatrixCSCComplex::pre_processing() {
  internal_order_test();
...
bool vinichuk_t_tbb::MultMatrixCSCComplex::validation() {
  internal_order_test();
...
bool vinichuk_t_tbb::MultMatrixCSCComplex::run() {
  internal_order_test();
  ...
  tbb::parallel_for(0, mtrx_B->num_cols, [&](int j) {
...
bool vinichuk_t_tbb::MultMatrixCSCComplex::post_processing() {
  internal_order_test();
  return true;
}
