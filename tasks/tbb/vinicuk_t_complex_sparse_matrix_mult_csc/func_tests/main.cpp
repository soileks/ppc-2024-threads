...
TEST(vinicuk_t_complex_sparse_matrix_mult_csc_omp, test_square_of_the_imaginary_part) {
...
TEST(vinicuk_t_complex_sparse_matrix_mult_csc_omp, test_single_element) {
