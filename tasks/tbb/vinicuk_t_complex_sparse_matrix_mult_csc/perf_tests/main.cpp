...
#include "tbb/vinicuk_t_complex_sparse_matrix_mult_csc/include/csc_complex_matrix.hpp"
#include "tbb/vinicuk_t_complex_sparse_matrix_mult_csc/include/ops_tbb.hpp"

using namespace vinichuk_t_tbb;

TEST(vinicuk_t_complex_sparse_matrix_mult_csc_omp, test_pipeline_run_10000x10000) {
  int n = 10000;
...
TEST(vinicuk_t_complex_sparse_matrix_mult_csc_omp, test_task_run_10000x10000) {
  int n = 10000;
  CSCComplexMatrix mtrx_A(n, n);
  CSCComplexMatrix mtrx_B(n, n);
  CSCComplexMatrix mtrx_res(n, n);
