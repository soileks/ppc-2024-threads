...
using namespace pozdnyakov_tbb;

TEST(pozdnyakov_v_rect_integral_tbb, Test_x_sub_y_1) {
  ...
  PozdnyakovTaskTBB testTaskParallel(taskDataPar);
...
TEST(pozdnyakov_v_rect_integral_tbb, Test_x_sub_y_2) {
  Func f = pozdnyakov_flin;
  int n = 100;
...
TEST(pozdnyakov_v_rect_integral_tbb, Test_x_mul_y) {
...
TEST(pozdnyakov_v_rect_integral_tbb, Test_y_sin_x) {
...
TEST(pozdnyakov_v_rect_integral_tbb, Test_x_exp_y) {
