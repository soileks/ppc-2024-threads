...
TEST(Parallel_troitsk_a_int_trapizoid_TBB, Test_1) {
  double a1 = 0.0;
  double b1 = 2.0;
  double a2 = 0.0;
  double b2 = 2.0;
  ...
  // Create Task
  troitsk_a_integral_trapezoid_tbb::TestTBBTaskSequentialtroitskIntegralTrapezoid testOmpTaskSequential(taskDataSeq,
                                                                                                        x_y_quadro);
  ...
  // Create Task
  troitsk_a_integral_trapezoid_tbb::TestTBBTaskParalleltroitskIntegralTrapezoid testOmpTaskParallel(taskDataPar,
                                                                                                    x_y_quadro);
...
TEST(Parallel_troitsk_a_int_trapizoid_TBB, Test_2) {
  double a1 = 0.0;
  ...
  // Create Task
  troitsk_a_integral_trapezoid_tbb::TestTBBTaskSequentialtroitskIntegralTrapezoid testTaskSequential(taskDataSeq,
                                                                                                     sin_cos);
...
TEST(Parallel_troitsk_a_int_trapizoid_TBB, Test_3) {
  double a1 = 0.0;
  double b1 = 1.0;
  double a2 = 0.0;
  double b2 = 1.0;
...
TEST(Parallel_troitsk_a_int_trapizoid_TBB, Test_4) {
  double a1 = 0.0;
  double b1 = 3.14159265358979323846;
  double a2 = 0.0;
  double b2 = 1;
...
TEST(Parallel_troitsk_a_int_trapizoid_TBB, Test_5) {
  double a1 = 1.0;
  double b1 = 2.0;
  double a2 = 1.0;
  double b2 = 2.0;
