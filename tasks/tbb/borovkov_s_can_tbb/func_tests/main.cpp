...
TEST(borovkov_s_tbb_func_tests, mult_3x3) {
  // Create data
  size_t size = 3;
  size_t block = 2;
  ...
  // Create Task
  BorovkovTbb::BorovkovCanMultMatrTbb testTaskTbb(taskDataTbb);
...
TEST(borovkov_s_tbb_func_tests, mult_4x4) {
  // Create data
  size_t size = 4;
  size_t block = 2;
...
TEST(borovkov_s_tbb_func_tests, mult_5x5) {
  // Create data
  size_t size = 5;
  size_t block = 3;
...
TEST(borovkov_s_tbb_func_tests, mult_6x6) {
  // Create data
  size_t size = 6;
  size_t block = 3;
...
TEST(borovkov_s_tbb_func_tests, mult_7x7) {
  // Create data
  size_t size = 7;
  size_t block = 4;
