...
bool BorovkovCanMultMatrTbb::pre_processing() {
  internal_order_test();
...
bool BorovkovCanMultMatrTbb::validation() {
  internal_order_test();
...
bool BorovkovCanMultMatrTbb::run() {
  internal_order_test();
...
bool BorovkovCanMultMatrTbb::post_processing() {
  internal_order_test();
