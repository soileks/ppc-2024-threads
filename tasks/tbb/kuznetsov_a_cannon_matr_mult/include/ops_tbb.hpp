...
class KuznetsovCannonMatrMultTbb : public ppc::core::Task {
 public:
  explicit KuznetsovCannonMatrMultTbb(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
