...
TEST(kutarin_a_sobel_tbb, Test_Sobel_Simple_Image_1x1) {
  const int height = 1;
  const int width = 1;
...
TEST(kutarin_a_sobel_tbb, Test_Sobel_Simple_Image_5x5) {
  const int height = 5;
  const int width = 5;
...
TEST(kutarin_a_sobel_tbb, Test_Sobel_Simple_Image_4x8) {
  constexpr int width = 4;
  constexpr int height = 8;

  std::array<int, width * height> inImage = {
        102, 88,  47,  121, 169,
        26,  158, 201, 159, 178,
        145, 107, 82,  112, 54,
        5,   47,  198, 27,  181,
  ...
  std::array<int, width * height> resultImage = {
        231, 184, 255, 255,
        255, 255, 255, 134,
        190, 69, 255, 255,
        255, 210, 255, 105,
...
TEST(kutarin_a_sobel_tbb, Test_Sobel_Simple_Image_8x8) {
  const int height = 8;
  const int width = 8;

  std::vector<int> inImage = {
        103, 93,  44,  126, 174, 31, 163, 206,
        164, 183, 150, 112, 87,  117, 59, 0,
        52,  193, 22,  186, 234, 179, 56, 76,
        177, 97,  62,  249, 80,  130, 135, 145,
        1,   7,   149, 103, 93,  44,  126, 174,
        31,  163, 206, 164, 183, 150, 112, 87,
        117, 59,  0,   52,  193, 22,  186, 234,
        179, 56,  76,  177, 97,  62,  249, 80
        };
  ...
  std::vector<int> resultImage = {
        255, 255, 255, 255, 255, 63, 255, 255,
        177, 172, 164, 255, 255, 255, 254, 255,
        225, 255, 141, 255, 186, 255, 255, 255,
        255, 255, 255, 255, 255, 255, 117, 255,
        255, 255, 255, 140, 255, 130, 228, 213,
        255, 255, 255, 176, 172, 164, 255, 244,
        255, 254, 255, 255, 255, 141, 255, 151,
...
TEST(kutarin_a_sobel_tbb, Test_Sobel_Simple_Image_10x10_Grad) {
  const int height = 10;
  const int width = 10;

  std::vector<int> inImage = {
        100, 100, 100, 100, 100, 100, 100, 100, 100, 100,
        100, 150, 150, 150, 150, 150, 150, 150, 100, 100,
        100, 150, 200, 200, 200, 200, 200, 150, 100, 100,
        100, 150, 200, 250, 250, 250, 200, 150, 100, 100,
        100, 150, 200, 250, 255, 250, 200, 150, 100, 100,
        100, 150, 200, 250, 250, 250, 200, 150, 100, 100,
        100, 150, 200, 200, 200, 200, 200, 150, 100, 100,
        100, 150, 150, 150, 150, 150, 150, 150, 100, 100,
        100, 100, 100, 100, 100, 100, 100, 100, 100, 100,
  ...
  std::vector<int> resultImage = {
        70, 158, 200, 200, 200, 200, 200, 158, 70, 0,
        158, 255, 255, 255, 255, 255, 255, 255, 158, 0,
        200, 255, 255, 255, 255, 255, 255, 255, 200, 0,
        200, 255, 255, 219, 210, 219, 255, 255, 200, 0,
        200, 255, 255, 210, 0, 210, 255, 255, 200, 0,
        200, 255, 255, 219, 210, 219, 255, 255, 200, 0,
        200, 255, 255, 255, 255, 255, 255, 255, 200, 0,
        158, 255, 255, 255, 255, 255, 255, 255, 158, 0,
        70, 158, 200, 200, 200, 200, 200, 158, 70, 0,
...
TEST(kutarin_a_sobel_tbb, Test_Sobel_SaltAndPepper_Noise_Image) {
  const int height = 15;
  const int width = 15;
