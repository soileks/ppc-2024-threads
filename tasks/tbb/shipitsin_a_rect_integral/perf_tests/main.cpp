...
TEST(shipitsin_a_rect_integral_tbb, test_pipeline_run) {
  double res = 217.0907;
  ...
  auto testTaskTBB = std::make_shared<ShipitsinTaskTBB>(taskDataSeq);
...
TEST(shipitsin_a_rect_integral_tbb, test_task_run) {
  double res = 217.0907;
  Func f = shipitsin_fxexpy;
  int n = 5000;
