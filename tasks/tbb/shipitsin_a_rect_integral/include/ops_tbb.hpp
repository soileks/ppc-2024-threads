...
class ShipitsinTaskTBB : public ppc::core::Task {
 public:
  explicit ShipitsinTaskTBB(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
