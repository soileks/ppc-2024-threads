...
// omp tests
TEST(konovalov_i_double_radix_sort_tbb, one_value_test_parallel) {
  // Create data
  ...
  // Create Task
  RadixSortTBBTaskParallel testTaskSequential(taskDataSeq);
...
TEST(konovalov_i_double_radix_sort_tbb, reverse_order_test_parallel) {
  // Create data
...
TEST(konovalov_i_double_radix_sort_tbb, random_order_test_parallel) {
  // Create data
  const size_t size = 5;
  std::mt19937 gen(1.0);
...
TEST(konovalov_i_double_radix_sort_tbb, large_amount_random_test_parallel) {
  // Create data
