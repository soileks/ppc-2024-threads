...
bool RadixSortTBBTaskParallel::pre_processing() {
  internal_order_test();
...
bool RadixSortTBBTaskParallel::validation() {
  internal_order_test();
...
void RadixSortTBBTaskParallel::radix_sort_seq(double* in, size_t size, std::vector<double>* ordered_local) {
  if (size != 0) {
    char* buf;
...
bool RadixSortTBBTaskParallel::run() {
  internal_order_test();
...
bool RadixSortTBBTaskParallel::post_processing() {
  internal_order_test();
