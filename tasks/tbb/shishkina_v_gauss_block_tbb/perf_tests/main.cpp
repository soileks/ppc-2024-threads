...
TEST(tbb_shishkina_v_gauss_block_tbb_perf_test, test_pipeline_run) {
  int height = 1000;
  int width = 1000;
  int min = 40;
  int max = 180;
  ...
  // Create data
  std::vector<int> in = getPicture2(height, width, min, max);
...
TEST(tbb_shishkina_v_gauss_block_tbb_perf_test, test_task_run) {
  int height = 1000;
  int width = 1000;
  int min = 40;
  int max = 180;
  ...
  // Create data
  std::vector<int> in_ = getPicture2(height, width, min, max);
