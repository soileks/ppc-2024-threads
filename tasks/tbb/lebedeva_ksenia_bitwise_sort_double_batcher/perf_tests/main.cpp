...
TEST(lebedeva_ksenia_bitwise_sort_double_batcher, test_pipeline_run) {
  // Create data
  std::vector<double> array = LebedevaKTbb::randomVector(1000000, -1000000, 1000000);
  ...
  // Create Task
  auto testRSDBtbbParallel = std::make_shared<LebedevaKTbb::RadixSortDoubleWithBatcherTbbParallel>(RSDBDataTbb);
