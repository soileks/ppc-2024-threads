...
TEST(veselov_m_matrcomplexmultyCCS, test_sizes_true) {
  ...
  // Create Task
  SparseMatrixComplexMultiTBBSequential SparseMatrixComplexMultiTBBSequential(taskDataSeq);
  ASSERT_EQ(SparseMatrixComplexMultiTBBSequential.validation(), true);
  ...
  // Create Task
  SparseMatrixComplexMultiTBBParallel SparseMatrixComplexMultiTBBParallel(taskDataParallel);
  ASSERT_EQ(SparseMatrixComplexMultiTBBParallel.validation(), true);
}
...
TEST(veselov_m_matrcomplexmultyCCS, test_sizes_false) {
  ...
  // Create Task
  SparseMatrixComplexMultiTBBSequential SparseMatrixComplexMultiTBBSequential(taskDataSeq);
  ASSERT_FALSE(SparseMatrixComplexMultiTBBSequential.validation());
  ...
  // Create Task
  SparseMatrixComplexMultiTBBParallel SparseMatrixComplexMultiTBBParallel(taskDataParallel);
  ASSERT_FALSE(SparseMatrixComplexMultiTBBParallel.validation());
}
...
TEST(veselov_m_matrcomplexmultyCCS, test_multy_correct) {
  ...
  // Create Task
  SparseMatrixComplexMultiTBBSequential SparseMatrixComplexMultiTBBSequential(taskDataSeq);
  SparseMatrixComplexMultiTBBSequential.validation();
  SparseMatrixComplexMultiTBBSequential.pre_processing();
  SparseMatrixComplexMultiTBBSequential.run();
  SparseMatrixComplexMultiTBBSequential.post_processing();
  ...
  // Create Task
  SparseMatrixComplexMultiTBBParallel SparseMatrixComplexMultiTBBParallel(taskDataParallel);
  SparseMatrixComplexMultiTBBParallel.validation();
  SparseMatrixComplexMultiTBBParallel.pre_processing();
  SparseMatrixComplexMultiTBBParallel.run();
  SparseMatrixComplexMultiTBBParallel.post_processing();
