...
TEST(afanasyev_a_image_contrast_enhacement_tbb, validation_error_input_pixels_empty) {
...
TEST(afanasyev_a_image_contrast_enhacement_tbb, validation_error_input_output_pixels_size_different) {
...
TEST(afanasyev_a_image_contrast_enhacement_tbb, test_small_pixels) {
...
TEST(afanasyev_a_image_contrast_enhacement_tbb, test_medium_pixels) {
  // clang-format off
...
TEST(afanasyev_a_image_contrast_enhacement_tbb, test_large_pixels) {
  // clang-format off
...
TEST(afanasyev_a_image_contrast_enhacement_tbb, test_large_random_pixels) {
