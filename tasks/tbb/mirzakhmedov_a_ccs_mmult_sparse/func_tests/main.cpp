...
#include "tbb/mirzakhmedov_a_ccs_mmult_sparse/include/ccs_mmult_sparse_tbb.hpp"

TEST(Mirzakhmedov_a_ccs_mmult_sparse_Tbb, test_I) {
  ...
  taskDataTbb->inputs.emplace_back(reinterpret_cast<uint8_t*>(&M1));
  taskDataTbb->inputs.emplace_back(reinterpret_cast<uint8_t*>(&M2));
  taskDataTbb->outputs.emplace_back(reinterpret_cast<uint8_t*>(&M3));

  // Create Task
  Tbb_MatMultCCS testTaskTbb(taskDataTbb);
...
TEST(Mirzakhmedov_a_ccs_mmult_sparse_Tbb, test_II) {
...
TEST(Mirzakhmedov_a_ccs_mmult_sparse_Tbb, test_III) {
...
TEST(Mirzakhmedov_a_ccs_mmult_sparse_Tbb, test_IV) {
  MatrixInCCS_Sparse M1(1, 1, 1);
  MatrixInCCS_Sparse M2(1, 1, 1);
  MatrixInCCS_Sparse M3;
...
TEST(Mirzakhmedov_a_ccs_mmult_sparse_Tbb, test_V) {
  std::complex<double> vvector(2.0, 1.0);
  MatrixInCCS_Sparse M1(50, 50);
