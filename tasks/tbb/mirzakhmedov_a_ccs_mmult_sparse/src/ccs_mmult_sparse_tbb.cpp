...
bool Tbb_MatMultCCS::pre_processing() {
  internal_order_test();
...
bool Tbb_MatMultCCS::validation() {
  internal_order_test();
...
bool Tbb_MatMultCCS::run() {
  ...
  tbb::parallel_for(tbb::blocked_range<int>(0, M3->c_n), [&](const tbb::blocked_range<int>& r) {
...
bool Tbb_MatMultCCS::post_processing() {
  internal_order_test();
  return true;
}
