...
#include "tbb/smirnova_d_complex_matrix_crs/include/ops_tbb.hpp"

using namespace smirnova_tbb;

TEST(smirnova_d_complex_matrix_crs_tbb, test_square_matrix_by_itself) {
  crs_matrix A;
  A.n_rows = 5;
  A.n_cols = 5;
  ...
  // Create Task
  TbbTestComplexMatrixCrsSeq taskSequential(taskDataSeq);
  ...
  // Create Task
  TbbTestComplexMatrixCrsPar taskParallel(taskDataPar);
...
TEST(smirnova_d_complex_matrix_crs_tbb, test_square_matrix) {
  crs_matrix A;
  A.n_rows = 4;
  A.n_cols = 4;
  A.pointer = {0, 2, 4, 6, 7};
...
TEST(smirnova_d_complex_matrix_crs_tbb, test_non_square_matrix) {
  crs_matrix A;
  A.n_rows = 2;
  A.n_cols = 3;
  A.pointer = {0, 2, 3};
  ...
  A_Par.n_cols = 3;
  A_Par.pointer = {0, 2, 3};
  A_Par.col_indexes = {0, 2, 1};
  A_Par.non_zero_values = {1, 2, 3};

  crs_matrix B_Par;
  B_Par.n_rows = 3;
  B_Par.n_cols = 3;
  B_Par.pointer = {0, 2, 3, 4};
...
TEST(smirnova_d_complex_matrix_crs_tbb, test_inverse_matrix) {
  crs_matrix A;
  A.n_rows = 4;
  A.n_cols = 4;
  A.pointer = {0, 1, 3, 5, 8};
...
TEST(smirnova_d_complex_matrix_crs_tbb, test_complex_matrix) {
  crs_matrix A;
  A.n_rows = 5;
  A.n_cols = 4;
...
TEST(smirnova_d_complex_matrix_crs_tbb, test_complex_matrix_diagonal) {
  crs_matrix A;
  A.n_rows = 3;
  A.n_cols = 3;
  A.pointer = {0, 1, 2, 3};
