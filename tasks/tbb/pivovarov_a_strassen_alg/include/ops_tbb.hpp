...
class TestTaskTBBParallelPivovarovStrassen : public ppc::core::Task {
 public:
  explicit TestTaskTBBParallelPivovarovStrassen(std::shared_ptr<ppc::core::TaskData> taskData_)
