...
TEST(soloninko_a_Test_Vec_OMP, Test_Vec_20_omp) {
  // Create data
  std::vector<int> vec = SoloninkoTBBBatcher::sol_GetRandVector(20);
  ...
  // Create Task
  SoloninkoTBBBatcher::TaskTBBSequentialBatcherSoloninko testTaskSequential(taskDataSeq);
  ...
  // Create Task
  SoloninkoTBBBatcher::TestTaskTBBParallelBatcherSoloninko testOmpTaskParallel(taskDataPar);
...
TEST(soloninko_a_Test_Vec_OMP, Test_Vec_40_omp) {
  // Create data
  std::vector<int> vec = SoloninkoTBBBatcher::sol_GetRandVector(40);
  std::vector<int> seq_res(vec.size(), 0);
...
TEST(soloninko_a_Test_Vec_OMP, Test_Vec_60_omp) {
  // Create data
  std::vector<int> vec = SoloninkoTBBBatcher::sol_GetRandVector(60);
  std::vector<int> seq_res(vec.size(), 0);
...
TEST(soloninko_a_Test_Vec_OMP, Test_Vec_80_omp) {
  // Create data
  std::vector<int> vec = SoloninkoTBBBatcher::sol_GetRandVector(80);
  std::vector<int> seq_res(vec.size(), 0);
...
TEST(soloninko_a_Test_Vec_OMP, Test_Vec_100_omp) {
  // Create data
  std::vector<int> vec = SoloninkoTBBBatcher::sol_GetRandVector(100);
  std::vector<int> seq_res(vec.size(), 0);
