...
TEST(Skotin_A_Multiply_Matrix_Cannon_Seq, test_pipeline_run) {
  ...
  auto matrixAData = SkotinTBBPerfTests::createMatrixData(matrixSize, 1.0);
  auto matrixBData = SkotinTBBPerfTests::createMatrixData(matrixSize, 2.0);
  ...
  auto task = std::make_shared<SkotinMatrixMultiplicationTBBParallel>(taskData);
  ...
  SkotinTBBPerfTests::checkMatrixMultiplicationResult(outputData, matrixSize, 10000.0);
}
...
TEST(Skotin_A_Multiply_Matrix_Cannon_Seq, test_task_run) {
  ...
  SkotinTBBPerfTests::checkMatrixMultiplicationResult(outputData, matrixSize, 11000.0);
}
