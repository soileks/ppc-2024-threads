...
bool TBBFilterGaussHorizontalSeqUlyanov::pre_processing() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalSeqUlyanov::validation() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalSeqUlyanov::run() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalSeqUlyanov::post_processing() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalParUlyanov::pre_processing() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalParUlyanov::validation() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalParUlyanov::run() {
  internal_order_test();
...
bool TBBFilterGaussHorizontalParUlyanov::post_processing() {
  internal_order_test();
