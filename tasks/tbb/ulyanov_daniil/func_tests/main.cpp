...
TEST(Par_TBB_Ulyanov, Test1_Ulyanov) {
  int height = 100;
  int width = 100;
  ...
  // Create Task
  TBBFilterGaussHorizontalSeqUlyanov testOmpTaskSequential(taskDataSeq);
...
TEST(Par_TBB_Ulyanov, Test2_Ulyanov) {
  int height = 500;
  int width = 500;
...
TEST(Par_TBB_Ulyanov, Test3_Ulyanov) {
  int height = 200;
  int width = 200;
...
TEST(Par_TBB_Ulyanov, Test4_Ulyanov) {
  int height = 123;
  int width = 123;
...
TEST(Par_TBB_Ulyanov, Test5_Ulyanov) {
  int height = 10;
  int width = 10;
