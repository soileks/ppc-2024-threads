...
TEST(salaev_v_components_marking_tbb_perf, test_pipeline_run) {
  // Create data
  ...
  // Create Task
  auto testTaskSequential = std::make_shared<ImageMarkingTBB>(taskDataSeq);
...
TEST(salaev_v_components_marking_tbb_perf, test_task_run) {
  // Create data
