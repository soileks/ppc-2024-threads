...
using namespace shipitsin_omp;

TEST(shipitsin_a_rect_integral_omp, Test_x_sub_y_1) {
  ...
  ShipitsinTaskOMP testTaskParallel(taskDataPar);
...
TEST(shipitsin_a_rect_integral_omp, Test_x_sub_y_2) {
  Func f = shipitsin_flin;
  int n = 100;
...
TEST(shipitsin_a_rect_integral_omp, Test_x_mul_y) {
...
TEST(shipitsin_a_rect_integral_omp, Test_y_sin_x) {
...
TEST(shipitsin_a_rect_integral_omp, Test_x_exp_y) {
