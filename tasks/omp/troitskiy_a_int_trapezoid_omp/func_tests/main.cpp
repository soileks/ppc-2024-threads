...
TEST(Parallel_troitskiy_a_int_trapizoid, Test_1) {
  double a1 = 0.0;
  double b1 = 2.0;
  double a2 = 0.0;
  double b2 = 2.0;
  ...
  // Create Task
  troitskiy_a_omp_integral_trapezoid::TestTaskSequentialtroitskiyIntegralTrapezoid testOmpTaskSequential(taskDataSeq,
                                                                                                     x_y_quadro);
  ...
  // Create Task
  troitskiy_a_omp_integral_trapezoid::TestOMPTaskParalleltroitskiyIntegralTrapezoid testOmpTaskParallel(taskDataPar,
                                                                                                    x_y_quadro);
...
TEST(Parallel_troitskiy_a_int_trapizoid, Test_2) {
  double a1 = 0.0;
  ...
  // Create Task
  troitskiy_a_omp_integral_trapezoid::TestTaskSequentialtroitskiyIntegralTrapezoid testTaskSequential(taskDataSeq, sin_cos);
...
TEST(Parallel_troitskiy_a_int_trapizoid, Test_3) {
  double a1 = 0.0;
  double b1 = 1.0;
  double a2 = 0.0;
  double b2 = 1.0;
  ...
  // Create Task
  troitskiy_a_omp_integral_trapezoid::TestTaskSequentialtroitskiyIntegralTrapezoid testTaskSequential(taskDataSeq, x_mul_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
...
TEST(Parallel_troitskiy_a_int_trapizoid, Test_4) {
  double a1 = 0.0;
  double b1 = 3.14159265358979323846;
  double a2 = 0.0;
  double b2 = 1;
  ...
  // Create Task
  troitskiy_a_omp_integral_trapezoid::TestTaskSequentialtroitskiyIntegralTrapezoid testTaskSequential(taskDataSeq,
                                                                                                  x_mult_sinY);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
...
TEST(Parallel_troitskiy_a_int_trapizoid, Test_5) {
  double a1 = 1.0;
  double b1 = 2.0;
  double a2 = 1.0;
  double b2 = 2.0;
  ...
  // Create Task
  troitskiy_a_omp_integral_trapezoid::TestTaskSequentialtroitskiyIntegralTrapezoid testTaskSequential(taskDataSeq, x_del_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
