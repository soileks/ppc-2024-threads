...
TEST(openmp_troitsk_a_int_trapezoid, test_pipeline_run) {
  double a1 = 0.0;
  ...
  // Create Task
  auto testTaskOMP = std::make_shared<troitsk_a_omp_integral_trapezoid::TestOMPTaskParalleltroitskIntegralTrapezoid>(
      taskDataSeq, sin_cos);
...
TEST(openmp_troitsk_a_int_trapezoid, test_task_run) {
  double a1 = 0.0;
  double b1 = 3.14159265358979323846;
  double a2 = 0.0;
  double b2 = 3.14159265358979323846;
