...
bool TestTaskSequentialtroitskiyIntegralTrapezoid::pre_processing() {
  internal_order_test();
...
bool TestTaskSequentialtroitskiyIntegralTrapezoid::validation() {
  internal_order_test();
  // Check count elements of output
  return taskData->inputs_count[0] == 4 && taskData->inputs_count[1] == 2 && taskData->outputs_count[0] == 1;
}

bool TestTaskSequentialtroitskiyIntegralTrapezoid::run() {
  internal_order_test();
  res = trapezoidal_integral(a1, b1, a2, b2, n1, n2, fun);
  return true;
}

bool TestTaskSequentialtroitskiyIntegralTrapezoid::post_processing() {
  internal_order_test();
  reinterpret_cast<double *>(taskData->outputs[0])[0] = res;
  return true;
}

bool TestOMPTaskParalleltroitskiyIntegralTrapezoid::pre_processing() {
  internal_order_test();
  // Init vectors
  a1 = reinterpret_cast<double *>(taskData->inputs[0])[0];
  b1 = reinterpret_cast<double *>(taskData->inputs[0])[1];
...
bool TestOMPTaskParalleltroitskiyIntegralTrapezoid::validation() {
  internal_order_test();
  // Check count elements of output
  return taskData->inputs_count[0] == 4 && taskData->inputs_count[1] == 2 && taskData->outputs_count[0] == 1;
}

bool TestOMPTaskParalleltroitskiyIntegralTrapezoid::run() {
  internal_order_test();
  res = trapezoidal_integral_omp(a1, b1, a2, b2, n1, n2, fun);
  return true;
}

bool TestOMPTaskParalleltroitskiyIntegralTrapezoid::post_processing() {
  internal_order_test();
  reinterpret_cast<double *>(taskData->outputs[0])[0] = res;
  return true;
}
