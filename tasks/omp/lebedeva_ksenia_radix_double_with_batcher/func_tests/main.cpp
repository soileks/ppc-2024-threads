...
TEST(lebedeva_k_bitwise_sort_double_batcher, arr) {
  ...
  // Create Task
  LebedevaKOmp::RadixSortDoubleWithBatcherSequential testRDSBSequential(RSDBDataSeq);
  ...
  // Create Task
  LebedevaKOmp::RadixSortDoubleWithBatcherOmpParallel testRDSBompParallel(RSDBDataOmp);
...
TEST(lebedeva_k_bitwise_sort_double_batcher, test_arr_2) {
  // Create data
  std::vector<double> arr = {1.345, 5.672, 8.943, 3.219, 6.785, 9.234, 2.109, 4.567, 7.890, 
                                0.123, 2.456, 6.789, 3.456, 8.901, 1.234, 9.876, 5.432, 0.987, 
                                4.321, 7.654, 2.109, 8.765, 3.098, 9.876, 0.543, 6.789, 4.321, 
                                1.234, 7.890, 5.432, 3.210, 2.345, 8.976, 6.543, 9.012, 0.987, 
                                4.321, 7.654, 5.678, 3.456, 1.234, 9.876, 2.109, 8.765, 0.543, 
                                6.789, 4.321, 7.890, 3.251, 7.539};
  // Create data
  std::vector<double> out_seq(arr.size());
...
TEST(lebedeva_k_bitwise_sort_double_batcher, test_with_negative) {
  // Create data
  std::vector<double> arr = {-3.217, 5.678, -1.234, 8.901, -2.345, 6.789, 4.321, -7.654, 2.109, -9.876, 0.543, 3.456, -8.765};
  // Create data
  std::vector<double> out_seq(arr.size());
