...
TEST(khramov_i_simpson_omp, Test_Linear_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 4;
  int b2 = 4;
  ...
  // Create Task
  TestSimpsonOmpSequential testTaskSequential(taskDataSeq, func);
  ...
  // Create Task
  TestSimpsonOmpParallel testTaskParallel(taskDataPar, func);
...
TEST(khramov_i_simpson_omp, Test_Square_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
...
TEST(khramov_i_simpson_omp, Test_Sin_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
...
TEST(khramov_i_simpson_omp, Test_Mult_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
...
TEST(khramov_i_simpson_omp, Test_Exp_Func) {
  int a1 = 0;
  int a2 = 0;
  int b1 = 3;
  int b2 = 3;
