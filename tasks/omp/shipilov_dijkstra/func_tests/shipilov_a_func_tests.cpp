...
TEST(Dijkstra_Shipilov_omp_test, Test_Correct_Work_One) {
  // Create data
...
TEST(Dijkstra_Shipilov_omp_test, Test_Correct_Work_Two) {
  // Create data
...
TEST(Dijkstra_Shipilov_omp_test, Test_Correct_Work_Three) {
  // Create data
...
TEST(Dijkstra_Shipilov_omp_test, Test_Correct_Work_Four) {
  // Create data
...
TEST(Dijkstra_Shipilov_omp_test, Test_Correct_Work_Five) {
  // Create data
