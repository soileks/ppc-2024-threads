...
TEST(salaev_v_components_marking_omp_perf, test_pipeline_run) {
  // Create data
  ...
  // Create Task
  auto testTaskSequential = std::make_shared<ImageMarkingOmp>(taskDataSeq);
...
TEST(salaev_v_components_marking_omp_perf, test_task_run) {
  // Create data
