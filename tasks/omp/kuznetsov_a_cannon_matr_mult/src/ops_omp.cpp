...
bool KuznetsovCannonMatrMultOmp::pre_processing() {
  internal_order_test();
...
bool KuznetsovCannonMatrMultOmp::validation() {
  internal_order_test();
...
bool KuznetsovCannonMatrMultOmp::run() {
  internal_order_test();
...
bool KuznetsovCannonMatrMultOmp::post_processing() {
  internal_order_test();
