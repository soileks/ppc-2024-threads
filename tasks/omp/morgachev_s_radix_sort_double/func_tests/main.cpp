...
TEST(morgachev_s_radix_sort_double_omp, test_one_number) {
  ...
  RadixSortDoubleOMP test(taskDataOMP);
...
TEST(morgachev_s_radix_sort_double_omp, test_with_simple_values) {
...
TEST(morgachev_s_radix_sort_double_omp, test_sorted_values) {
...
TEST(morgachev_s_radix_sort_double_omp, test_reversed_values) {
...
TEST(morgachev_s_radix_sort_double_omp, test_with_duplicate_values) {
