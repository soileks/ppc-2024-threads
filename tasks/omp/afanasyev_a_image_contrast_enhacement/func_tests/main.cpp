...
TEST(afanasyev_a_image_contrast_enhacement_omp, validation_error_input_pixels_empty) {
...
TEST(afanasyev_a_image_contrast_enhacement_omp, validation_error_input_output_pixels_size_different) {
...
TEST(afanasyev_a_image_contrast_enhacement_omp, test_small_pixels) {
...
TEST(afanasyev_a_image_contrast_enhacement_omp, test_medium_pixels) {
  // clang-format off
...
TEST(afanasyev_a_image_contrast_enhacement_omp, test_large_pixels) {
  // clang-format off
...
TEST(afanasyev_a_image_contrast_enhacement_omp, test_large_random_pixels) {
