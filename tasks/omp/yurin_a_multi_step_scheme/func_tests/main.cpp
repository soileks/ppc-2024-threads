...
TEST(Yurin_A_Multi_Step_Scheme_OMP, incorrect_data) {
  ...
  // Create Task
  MultiStepSchemeOMP multiStepSchemeOMP(taskDataSeq);

  ASSERT_FALSE(multiStepSchemeOMP.validation());
}

TEST(Yurin_A_Multi_Step_Scheme_OMP, simple_test) {
  // Create data
...
TEST(Yurin_A_Multi_Step_Scheme_OMP, first_test) {
  // Create data
  std::vector<double> equation{-2, -3, 1, -2, 0, 0};
...
TEST(Yurin_A_Multi_Step_Scheme_OMP, second_test) {
  // Create data
...
TEST(Yurin_A_Multi_Step_Scheme_OMP, fird_test) {
  // Create data
