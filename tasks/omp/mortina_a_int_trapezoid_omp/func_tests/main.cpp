...
TEST(Parallel_mortina_a_int_trapizoid, Test_1) {
  double a1 = 0.0;
  double b1 = 2.0;
  double a2 = 0.0;
  double b2 = 2.0;
...
TEST(Parallel_mortina_a_int_trapizoid, Test_2) {
  ...
  // Create Task
  Mortina_a_omp_integral_trapezoid::TestTaskSequentialMortinaIntegralTrapezoid testTaskSequential(taskDataSeq, sin_cos);
...
TEST(Parallel_mortina_a_int_trapizoid, Test_3) {
  ...
  // Create Task
  Mortina_a_omp_integral_trapezoid::TestTaskSequentialMortinaIntegralTrapezoid testTaskSequential(taskDataSeq, x_mul_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
...
TEST(Parallel_mortina_a_int_trapizoid, Test_5) {
  ...
  // Create Task
  Mortina_a_omp_integral_trapezoid::TestTaskSequentialMortinaIntegralTrapezoid testTaskSequential(taskDataSeq, x_del_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
