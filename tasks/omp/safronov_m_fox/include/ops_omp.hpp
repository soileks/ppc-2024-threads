...
class SafronovSeqFoxAlgTaskOMP : public ppc::core::Task {
 public:
  explicit SafronovSeqFoxAlgTaskOMP(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
