...
class TestTaskOMPParallelPivovarovStrassen : public ppc::core::Task {
 public:
  explicit TestTaskOMPParallelPivovarovStrassen(std::shared_ptr<ppc::core::TaskData> taskData_)
