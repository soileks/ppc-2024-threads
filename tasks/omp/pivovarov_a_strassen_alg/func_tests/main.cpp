...
TEST(Pivovarov_a_strassen_alg_omp, Multiplication_4x4) {
  int n = 4;
  ...
  // Create Task
  TestTaskOMPParallelPivovarovStrassen test(taskDataSeq);
...
TEST(Pivovarov_a_strassen_alg_omp, Multiplication_8x8) {
  int n = 8;
...
TEST(Pivovarov_a_strassen_alg_omp, Multiplication_16x16) {
  int n = 16;
...
TEST(Pivovarov_a_strassen_alg_omp, Multiplication_32x32) {
  int n = 32;
...
TEST(Pivovarov_a_strassen_alg_omp, Multiplication_64x64) {
  int n = 64;
