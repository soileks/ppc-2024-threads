...
TEST(bakhtiarov_a_matrix_mult_ccs_omp, test_sizes2) {
  size_t n1 = 4;
  size_t m1 = 4;
  size_t n2 = 4;
  size_t m2 = 4;
...
TEST(bakhtiarov_a_matrix_mult_ccs_omp, test_multy_correct) {
  size_t n1 = 4;
  size_t m1 = 4;
  size_t n2 = 4;
  size_t m2 = 4;
...
TEST(bakhtiarov_a_matrix_mult_ccs_omp, inverse_matrix) {
  size_t n1 = 4;
  size_t m1 = 4;
  size_t n2 = 4;
  size_t m2 = 4;
...
TEST(bakhtiarov_a_matrix_mult_ccs_omp, zero_matrix) {
  size_t n1 = 3;
  size_t m1 = 3;
  size_t n2 = 3;
  size_t m2 = 3;
