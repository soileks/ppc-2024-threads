...
TEST(kutarin_a_sobel_omp, Test_Sobel_Simple_Image_1x1) {
  const int height = 1;
  const int width = 1;
  ...
  KutarinASobel sobelTaskOmp(taskDataOmp);
...
TEST(kutarin_a_sobel_omp, Test_Sobel_Simple_Image_5x5) {
  const int height = 5;
  const int width = 5;
...
TEST(kutarin_a_sobel_omp, Test_Sobel_Simple_Image_4x8) {
...
TEST(kutarin_a_sobel_omp, Test_Sobel_Simple_Image_8x8) {
  const int height = 8;
  const int width = 8;
...
TEST(kutarin_a_sobel_omp, Test_Sobel_Simple_Image_10x10_Grad) {
  const int height = 10;
  const int width = 10;
...
TEST(kutarin_a_sobel_omp, Test_Sobel_SaltAndPepper_Noise_Image) {
  const int height = 15;
  const int width = 15;
