...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_Simple_Image_5x5_Parallel) {
  const int height = 5;
  const int width = 5;
  ...
  SobelTaskParallel sobelTaskParallel(taskData_omp);
  ASSERT_EQ(sobelTaskParallel.validation(), true);
  sobelTaskParallel.pre_processing();
  sobelTaskParallel.run();
  sobelTaskParallel.post_processing();
...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_Simple_Image_5x7_Parallel) {
  const int width = 5;
  const int height = 7;
...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_Simple_Image_11x11_Parallel) {
  const int height = 11;
  const int width = 11;
...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_White_Image_Parallel) {
  const int height = 5;
  const int width = 5;
...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_Black_Image_Parallel) {
  const int width = 5;
  const int height = 5;
...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_Random_Image_Parallel) {
  const int width = 256;
...
TEST(kutarin_a_image_sobel_operator, Test_Sobel_Random_Image_2_Parallel) {
  const int width = 300;
