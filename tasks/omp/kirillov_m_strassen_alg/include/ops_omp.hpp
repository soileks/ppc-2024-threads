...
namespace kirillov_omp {
class StrassenMatrixMultParallelOMP : public ppc::core::Task {
 public:
  explicit StrassenMatrixMultParallelOMP(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
