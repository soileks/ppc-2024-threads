...
namespace prokofev_k_covexHull_Omp {
...
class BinaryImageConvexHullOmp : public ppc::core::Task {
 public:
  explicit BinaryImageConvexHullOmp(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
