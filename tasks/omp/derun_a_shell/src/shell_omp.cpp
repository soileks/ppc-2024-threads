...
std::vector<int> ShellOMP::shell_sort(const std::vector<int>& input) {
...
bool ShellOMP::checkSorted(std::vector<int> input) { return std::is_sorted(input.begin(), input.end()); }

std::vector<int> ShellOMP::generate_random_vector(int size, int min, int max) {
