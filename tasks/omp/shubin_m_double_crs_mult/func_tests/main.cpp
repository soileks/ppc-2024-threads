...
TEST(shubin_m_double_crs_mult_omp, incorr_in_mats) {
  ...
  taskDataOMP->inputs.emplace_back(reinterpret_cast<uint8_t *>(&mat_in_1));
  taskDataOMP->inputs.emplace_back(reinterpret_cast<uint8_t *>(&mat_in_2));
  taskDataOMP->outputs.emplace_back(reinterpret_cast<uint8_t *>(&mat_out));

  SparseMat_CRS_Mult_OMP crs_mat_mult_omp(taskDataOMP);
  ASSERT_FALSE(crs_mat_mult_omp.validation());
}

TEST(shubin_m_double_crs_mult_omp, mat_in_1_zero) {
  ...
  SparseMat_CRS_Mult_OMP crs_mat_mult_omp(taskDataOMP);
  ASSERT_TRUE(crs_mat_mult_omp.validation());
  ASSERT_TRUE(crs_mat_mult_omp.pre_processing());
  ASSERT_TRUE(crs_mat_mult_omp.run());
  ASSERT_TRUE(crs_mat_mult_omp.post_processing());
...
TEST(shubin_m_double_crs_mult_omp, mat_in_2_zero) {
  size_t mat_in_1_row = 3;
  size_t mat_in_1_col = 3;
  size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
...
TEST(shubin_m_double_crs_mult_omp, mat_in_1_ident) {
  size_t mat_in_1_row = 3;
  // size_t mat_in_1_col = 3;
  size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
...
TEST(shubin_m_double_crs_mult_omp, mat_in_2_ident) {
  size_t mat_in_1_row = 3;
  size_t mat_in_1_col = 3;
  // size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
...
TEST(shubin_m_double_crs_mult_omp, random_small_dim_mat_mult) {
  size_t mat_in_1_row = 3;
  size_t mat_in_1_col = 3;
  size_t mat_in_2_row = 3;
  size_t mat_in_2_col = 3;
  ...
  SparseMat_CRS mat_in_1(A, mat_in_1_row, mat_in_1_col);
  SparseMat_CRS mat_in_2(B, mat_in_2_row, mat_in_2_col);
  SparseMat_CRS mat_out(mat_in_1_row, mat_in_2_col);
