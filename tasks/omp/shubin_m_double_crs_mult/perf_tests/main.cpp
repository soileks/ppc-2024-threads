...
TEST(shubin_m_double_crs_mult_omp, test_pipeline_run) {
  ...
  auto testTaskOMP = std::make_shared<SparseMat_CRS_Mult_OMP>(taskDataOMP);
...
TEST(shubin_m_double_crs_mult_omp, test_task_run) {
  size_t mat_in_1_row = 700;
  size_t mat_in_cr = 700;
  size_t mat_in_2_col = 700;
  std::vector<double> A(mat_in_1_row * mat_in_cr);
