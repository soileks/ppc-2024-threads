...
TEST(bozin_d_trapez_omp, Test1) {
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testTaskSequential(taskDataSeq, sqr_x_y);
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testOmpTaskParallel(taskDataPar, sqr_x_y);
...
TEST(bozin_d_trapez_omp, Test2) {
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testTaskSequential(taskDataSeq, mul_x_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testOmpTaskParallel(taskDataPar, mul_x_y);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(bozin_d_trapez_omp, Test3) {
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testTaskSequential(taskDataSeq, trigm_x_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testOmpTaskParallel(taskDataPar, trigm_x_y);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(bozin_d_trapez_omp, Test4) {
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testTaskSequential(taskDataSeq, trigmul_x_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testOmpTaskParallel(taskDataPar, trigmul_x_y);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
...
TEST(bozin_d_trapez_omp, Test5) {
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testTaskSequential(taskDataSeq, divide_x_y);
  ASSERT_EQ(testTaskSequential.validation(), true);
  testTaskSequential.pre_processing();
  testTaskSequential.run();
  testTaskSequential.post_processing();
  ...
  // Create Task
  Bozin_d_omp::BozinTaskParralel testOmpTaskParallel(taskDataPar, divide_x_y);
  ASSERT_EQ(testOmpTaskParallel.validation(), true);
  testOmpTaskParallel.pre_processing();
  testOmpTaskParallel.run();
  testOmpTaskParallel.post_processing();
