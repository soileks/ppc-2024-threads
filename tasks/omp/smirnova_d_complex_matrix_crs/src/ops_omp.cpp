...
smirnova_omp::crs_matrix smirnova_omp::T(const crs_matrix& M) {
...
bool smirnova_omp::is_crs(const crs_matrix& M) {
...
bool smirnova_omp::TestComplexMatrixCrsSeq::pre_processing() {
  internal_order_test();
...
bool smirnova_omp::TestComplexMatrixCrsSeq::validation() {
  internal_order_test();
...
bool smirnova_omp::TestComplexMatrixCrsSeq::run() {
  internal_order_test();
...
bool smirnova_omp::TestComplexMatrixCrsSeq::post_processing() {
  internal_order_test();

  return true;
}

bool smirnova_omp::TestComplexMatrixCrsPar::pre_processing() {
  internal_order_test();
...
bool smirnova_omp::TestComplexMatrixCrsPar::validation() {
  internal_order_test();
...
bool smirnova_omp::TestComplexMatrixCrsPar::run() {
  internal_order_test();
...
bool smirnova_omp::TestComplexMatrixCrsPar::post_processing() {
  internal_order_test();
