...
Pixel& PixelMap::get_pixel(uint64_t i, uint64_t j) { return this->data[i * width() + j]; }

const Pixel& PixelMap::get_pixel(uint64_t i, uint64_t j) const { return this->data[i * width() + j]; }
