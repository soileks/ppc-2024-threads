...
TEST(kriseev_m_convex_hull_graham_omp, ThreePoints) {
...
TEST(kriseev_m_convex_hull_graham_omp, Square) {
  std::vector<double> pX;
  pX.emplace_back(2.0);
  pX.emplace_back(5.0);
  pX.emplace_back(5.0);
...
TEST(kriseev_m_convex_hull_graham_omp, SquareWithPointInTheMiddle) {
  std::vector<double> pX;
  pX.emplace_back(2.0);
  pX.emplace_back(5.0);
  pX.emplace_back(5.0);
...
TEST(kriseev_m_convex_hull_graham_omp, SquareWithPointOnEdge) {
  std::vector<double> pX;
  pX.emplace_back(2.0);
  pX.emplace_back(5.0);
  pX.emplace_back(5.0);
...
TEST(kriseev_m_convex_hull_graham_omp, PentagonWithPointsInside) {
  std::vector<double> pX;
  pX.emplace_back(1.5);
