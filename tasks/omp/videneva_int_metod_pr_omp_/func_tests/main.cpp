...
TEST(videneva_int_metod_pr_omp_func, small) {
  ...
  Videneva_opm_task videneva_opm_task(data_seq);
...
TEST(videneva_int_metod_pr_omp_func, normal) {
...
TEST(videneva_int_metod_pr_omp_func, null) {
...
TEST(videneva_int_metod_pr_omp_func, negative) {
...
TEST(videneva_int_metod_pr_omp_func, negativeLarge) {
