...
TEST(kashirin_a_int_radix_sort_batcher_omp, Test_sort_10) {
  ...
  // Create Task
  OmpIntRadixSortWithBatcherMerge testTaskSequential(taskDataSeq);
...
TEST(kashirin_a_int_radix_sort_batcher_omp, Test_sort_20) {
  const int count = 20;
...
TEST(kashirin_a_int_radix_sort_batcher_omp, Test_sort_50) {
  const int count = 50;
...
TEST(kashirin_a_int_radix_sort_batcher_omp, Test_sort_70) {
  const int count = 70;
...
TEST(kashirin_a_int_radix_sort_batcher_omp, Test_sort_100) {
  const int count = 100;
