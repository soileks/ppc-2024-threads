...
TEST(ermolaev_d_fox_algorithm_omp, Test_Matrix_Multiplication_Simple_256) {
...
TEST(ermolaev_d_fox_algorithm_omp, Test_Matrix_Multiplication_Random_256) {
  constexpr size_t matrix_size = 256;
  const double tolerance = 1e-5;
  std::mt19937 gen(1);
  std::uniform_real_distribution<> dis(5.0, 1e-5);
...
TEST(ermolaev_d_fox_algorithm_omp, Test_Matrix_Multiplication_Simple_512) {
...
TEST(ermolaev_d_fox_algorithm_omp, Test_Matrix_Multiplication_Random_512) {
  constexpr size_t matrix_size = 512;
  const double tolerance = 1e-5;
  std::mt19937 gen(1);
  std::uniform_real_distribution<> dis(5.0, 1e-5);
