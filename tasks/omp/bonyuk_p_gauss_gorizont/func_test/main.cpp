...
#include "omp/bonyuk_p_gauss_gorizont/include/ops_omp.hpp"

TEST(bonyuk_p_gauss_gorizont, one_omp_test) {
  int n = 3;
  int m = 3;
...
TEST(bonyuk_p_gauss_gorizont, two_omp_test) {
  int n = 3;
  int m = 3;
...
TEST(bonyuk_p_gauss_gorizont, three_omp_test) {
  int n = 3;
  int m = 3;
...
TEST(bonyuk_p_gauss_gorizont, four_omp_test) {
  int n = 5;
  int m = 5;
...
TEST(bonyuk_p_gauss_gorizont, five_omp_test) {
  int n = 5;
  int m = 5;
