...
vector<int> mergeElements(vector<int> &vec1, vector<int> &vec2, size_t &idx1, size_t &idx2, size_t increment, int threads_count) {
...
vector<int> runBatcherSort(vector<int> &vec1, vector<int> &vec2) {
    return batcherSort(vec1, vec2);
}
